...
const luaL_Reg Lua_MonsterType_Enemies_Metatable[] = {//weapons and 
...
//for integers
#define	simplegetter(name, field)	\
static int  Lua_Monster_Get_ ## name(lua_State *L) {	\
	lua_pushnumber(L, (double) get_monster_data(Lua_Monster::Index(L, 1))->getDefinition()->field);	return 1;}\
static int Lua_Monster_Set_##name(lua_State *L)\
{\
	if (!lua_isnumber(L, 2))\
		return luaL_error(L, #field": incorrect argument type");\
	get_monster_data(Lua_Monster::Index(L, 1))->getDefinition()->field = \
			static_cast<int>(lua_tonumber(L, 2));\
	return 0;\
}

//for world_distance fields
#define	wdgetter(name, field)\
static int Lua_Monster_Get_##name(lua_State *L)\
{\
	lua_pushnumber(L, (double) get_monster_data(Lua_Monster::Index(L, 1))->getDefinition()->field / WORLD_ONE);\
	return 1;\
}\
static int Lua_Monster_Set_##name(lua_State *L)\
{\
...
//for _fixed fields
#define	fixedgetter(name, field)\
static int Lua_Monster_Get_##name(lua_State *L)\
{\
	lua_pushnumber(L, (double) get_monster_data(Lua_Monster::Index(L, 1))->getDefinition()->field / FIXED_ONE);\
	return 1;\
}\
static int Lua_Monster_Set_##name(lua_State *L)\
{\
	if (!lua_isnumber(L, 2))\
		return luaL_error(L, #field": incorrect argument type");\
	get_monster_data(Lua_Monster::Index(L, 1))->getDefinition()->field = \
			static_cast<int>(lua_tonumber(L, 2) * FIXED_ONE);\
	return 0;\
}
//for angle fields
#define	anglegetter(name, field)\
static int Lua_Monster_Get_##name(lua_State *L)\
{\
	lua_pushnumber(L, (double) get_monster_data(Lua_Monster::Index(L, 1))->getDefinition()->field * AngleConvert);\
	return 1;\
}\
static int Lua_Monster_Set_##name(lua_State *L)\
{\
	if (!lua_isnumber(L, 2))\
		return luaL_error(L, #field": incorrect argument type");\
	get_monster_data(Lua_Monster::Index(L, 1))->getDefinition()->field = \
			static_cast<int>(lua_tonumber(L, 2) / AngleConvert);\
	return 0;\
}

simplegetter(Collection, collection)
simplegetter(Immunities, immunities)
simplegetter(Weaknesses, weaknesses)
simplegetter(Flags, flags)
simplegetter(Class, _class)
simplegetter(Friends, friends)
simplegetter(Enemies, enemies)

fixedgetter(Sound_Pitch, sound_pitch)

simplegetter(Activation_Sound, activation_sound)
simplegetter(Friendly_Activation_Sound, friendly_activation_sound)
simplegetter(Clear_Sound, clear_sound)
simplegetter(Kill_Sound, kill_sound)
simplegetter(Apology_Sound, apology_sound)
simplegetter(Friendly_Fire_Sound, friendly_fire_sound)
simplegetter(Flaming_Sound, flaming_sound)
simplegetter(Random_Sound, random_sound)
simplegetter(Random_Sound_Mask, random_sound_mask)

simplegetter(Carrying_Item_Type, carrying_item_type)

wdgetter(Radius, radius)
wdgetter(Height, height)

wdgetter(Preferred_Hover_Height, preferred_hover_height)
wdgetter(Minimum_Ledge_Delta, minimum_ledge_delta)
wdgetter(Maximum_Ledge_Delta, maximum_ledge_delta)

fixedgetter(External_Velocity_Scale, external_velocity_scale)

simplegetter(Impact_Effect, impact_effect)
simplegetter(Melee_Impact_Effect, melee_impact_effect)
simplegetter(Contrail_Effect, contrail_effect)

anglegetter(Half_Visual_Arc, half_visual_arc)
anglegetter(Half_Vertical_Visual_Arc, half_vertical_visual_arc)

wdgetter(Visual_Range, visual_range)
wdgetter(Dark_Visual_Range, dark_visual_range)
simplegetter(Intelligence, intelligence)

wdgetter(Speed, speed)
wdgetter(Gravity, gravity)
wdgetter(Terminal_Velocity, terminal_velocity)

simplegetter(Door_Retry_Mask, door_retry_mask)
wdgetter(Shrapnel_Radius, shrapnel_radius)

simplegetter(Hit_Shapes, hit_shapes)
simplegetter(Hard_Dying_Shape, hard_dying_shape)
simplegetter(Soft_Dying_Shape, soft_dying_shape)
simplegetter(Hard_Dead_Shapes, hard_dead_shapes)
simplegetter(Soft_Dead_Shapes, soft_dead_shapes)
simplegetter(Stationary_Shape, stationary_shape)
simplegetter(Moving_Shape, moving_shape)
simplegetter(Teleport_In_Shape, teleport_in_shape)
simplegetter(Teleport_Out_Shape, teleport_out_shape)
simplegetter(Attack_Frequency, attack_frequency)
...
const luaL_Reg Lua_Monster_Get[] = {
	...
	{"z", Lua_Monster_Get_Z},
	{"collection", Lua_Monster_Get_Collection},
	{"immunities", Lua_Monster_Get_Immunities},
	{"weaknesses", Lua_Monster_Get_Weaknesses},
	{"flags", Lua_Monster_Get_Flags},
	{"_class", Lua_Monster_Get_Class},
	{"friends", Lua_Monster_Get_Friends},
	{"enemies", Lua_Monster_Get_Enemies},
	{"sound_pitch",  Lua_Monster_Get_Sound_Pitch},
	{"activation_sound", Lua_Monster_Get_Activation_Sound},
	{"friendly_activation_sound",  Lua_Monster_Get_Friendly_Activation_Sound},
	{"clear_sound", Lua_Monster_Get_Clear_Sound},
	{"kill_sound", Lua_Monster_Get_Kill_Sound},
	{"apology_sound", Lua_Monster_Get_Apology_Sound},
	{"friendly_fire_sound", Lua_Monster_Get_Friendly_Fire_Sound},
	{"flaming_sound",  Lua_Monster_Get_Flaming_Sound},
	{"random_sound", Lua_Monster_Get_Random_Sound},
	{"random_sound_mask", Lua_Monster_Get_Random_Sound_Mask},
	{"carrying_item_type", Lua_Monster_Get_Carrying_Item_Type},
	{"radius", Lua_Monster_Get_Radius},
	{"height", Lua_Monster_Get_Height},
	{"preferred_hover_height", Lua_Monster_Get_Preferred_Hover_Height},
	{"minimum_ledge_delta", Lua_Monster_Get_Minimum_Ledge_Delta},
	{"maximum_ledge_delta", Lua_Monster_Get_Maximum_Ledge_Delta},
	{"external_velocity_scale", Lua_Monster_Get_External_Velocity_Scale},
	{"impact_effect", Lua_Monster_Get_Impact_Effect},
	{"melee_impact_effect", Lua_Monster_Get_Melee_Impact_Effect},
	{"contrail_effect", Lua_Monster_Get_Contrail_Effect},
	{"half_visual_arc", Lua_Monster_Get_Half_Visual_Arc},
	{"half_vertical_visual_arc", Lua_Monster_Get_Half_Vertical_Visual_Arc},
	{"visual_range", Lua_Monster_Get_Visual_Range},
	{"dark_visual_range", Lua_Monster_Get_Dark_Visual_Range},
	{"intelligence", Lua_Monster_Get_Intelligence},
	{"speed", Lua_Monster_Get_Speed},
	{"gravity", Lua_Monster_Get_Gravity},
	{"terminal_velocity", Lua_Monster_Get_Terminal_Velocity},
	{"door_retry_mask", Lua_Monster_Get_Door_Retry_Mask},
	{"shrapnel_radius", Lua_Monster_Get_Shrapnel_Radius},
	{"hit_shapes", Lua_Monster_Get_Hit_Shapes},
	{"hard_dying_shape", Lua_Monster_Get_Hard_Dying_Shape},
	{"soft_dying_shape", Lua_Monster_Get_Soft_Dying_Shape},
	{"hard_dead_shapes", Lua_Monster_Get_Hard_Dead_Shapes},
	{"soft_dead_shapes", Lua_Monster_Get_Soft_Dead_Shapes},
	{"stationary_shape", Lua_Monster_Get_Stationary_Shape},
	{"moving_shape", Lua_Monster_Get_Moving_Shape},
	{"teleport_in_shape", Lua_Monster_Get_Teleport_In_Shape},
	{"teleport_out_shape", Lua_Monster_Get_Teleport_Out_Shape},
	{"attack_frequency", Lua_Monster_Get_Attack_Frequency},
	{0, 0}
};
...
const luaL_Reg Lua_Monster_Set[] = {
	...
	{"collection", Lua_Monster_Set_Collection},
	{"immunities", Lua_Monster_Set_Immunities},
	{"weaknesses", Lua_Monster_Set_Weaknesses},
	{"flags", Lua_Monster_Set_Flags},
	{"_class", Lua_Monster_Set_Class},
	{"friends", Lua_Monster_Set_Friends},
	{"enemies", Lua_Monster_Set_Enemies},
	{"sound_pitch",  Lua_Monster_Set_Sound_Pitch},
	{"activation_sound", Lua_Monster_Set_Activation_Sound},
	{"friendly_activation_sound",  Lua_Monster_Set_Friendly_Activation_Sound},
	{"clear_sound", Lua_Monster_Set_Clear_Sound},
	{"kill_sound", Lua_Monster_Set_Kill_Sound},
	{"apology_sound", Lua_Monster_Set_Apology_Sound},
	{"friendly_fire_sound", Lua_Monster_Set_Friendly_Fire_Sound},
	{"flaming_sound",  Lua_Monster_Set_Flaming_Sound},
	{"random_sound", Lua_Monster_Set_Random_Sound},
	{"random_sound_mask", Lua_Monster_Set_Random_Sound_Mask},
	{"carrying_item_type", Lua_Monster_Set_Carrying_Item_Type},
	{"radius", Lua_Monster_Set_Radius},
	{"height", Lua_Monster_Set_Height},
	{"preferred_hover_height", Lua_Monster_Set_Preferred_Hover_Height},
	{"minimum_ledge_delta", Lua_Monster_Set_Minimum_Ledge_Delta},
	{"maximum_ledge_delta", Lua_Monster_Set_Maximum_Ledge_Delta},
	{"external_velocity_scale", Lua_Monster_Set_External_Velocity_Scale},
	{"impact_effect", Lua_Monster_Set_Impact_Effect},
	{"melee_impact_effect", Lua_Monster_Set_Melee_Impact_Effect},
	{"contrail_effect", Lua_Monster_Set_Contrail_Effect},
	{"half_visual_arc", Lua_Monster_Set_Half_Visual_Arc},
	{"half_vertical_visual_arc", Lua_Monster_Set_Half_Vertical_Visual_Arc},
	{"visual_range", Lua_Monster_Set_Visual_Range},
	{"dark_visual_range", Lua_Monster_Set_Dark_Visual_Range},
	{"intelligence", Lua_Monster_Set_Intelligence},
	{"speed", Lua_Monster_Set_Speed},
	{"gravity", Lua_Monster_Set_Gravity},
	{"terminal_velocity", Lua_Monster_Set_Terminal_Velocity},
	{"door_retry_mask", Lua_Monster_Set_Door_Retry_Mask},
	{"shrapnel_radius", Lua_Monster_Set_Shrapnel_Radius},
	{"hit_shapes", Lua_Monster_Set_Hit_Shapes},
	{"hard_dying_shape", Lua_Monster_Set_Hard_Dying_Shape},
	{"soft_dying_shape", Lua_Monster_Set_Soft_Dying_Shape},
	{"hard_dead_shapes", Lua_Monster_Set_Hard_Dead_Shapes},
	{"soft_dead_shapes", Lua_Monster_Set_Soft_Dead_Shapes},
	{"stationary_shape", Lua_Monster_Set_Stationary_Shape},
	{"moving_shape", Lua_Monster_Set_Moving_Shape},
