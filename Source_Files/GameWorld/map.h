...
struct object_location
{
	...
	FLAGTEST(hangingFromCeiling, setHangsFromCeiling, _map_object_hanging_from_ceiling)
	FLAGTEST(isBlind, setBlind, _map_object_is_blind)
	FLAGTEST(isDeaf, setDeaf, _map_object_is_deaf)
	FLAGTEST(doesFloat, setDoesFloat, _map_object_floats)
	FLAGTEST(isNetworkOnly, setNetworkOnly, _map_object_is_network_only)
...
void initialize_map_for_new_player();
