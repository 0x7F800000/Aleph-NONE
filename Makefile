...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/AlephOne.spec.in \
	...
	ChangeLog THANKS config.guess config.sub depcomp install-sh \
	missing
...
ACLOCAL = ${SHELL} /home/radverbial/marathon-code/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /home/radverbial/marathon-code/missing --run autoconf
AUTOHEADER = ${SHELL} /home/radverbial/marathon-code/missing --run autoheader
AUTOMAKE = ${SHELL} /home/radverbial/marathon-code/missing --run automake-1.11
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2
CPP = gcc -E
CPPFLAGS =     -I/usr/include/libpng12   -D_FORTIFY_SOURCE=2    -I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT -DSDL
CXX = g++
CXXCPP = g++ -E
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lasound -lspeexdsp -lspeex -lavcodec -lavformat -lavutil -lswscale   -lvorbisfile -lvorbis -lm -logg   -lsndfile -lmad -lpng12   -Wl,-Bsymbolic-functions -Wl,-z,relro -lzzip -lz   -lz -lSDL_net -lSDL_ttf -lSDL_image  -L/usr/lib/x86_64-linux-gnu -lSDL -lGL -lpthread -lGLU
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/radverbial/marathon-code/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = AlephOne
PACKAGE_BUGREPORT = http://sourceforge.net/bugs/?group_id=1997
PACKAGE_NAME = Aleph One/SDL
PACKAGE_STRING = Aleph One/SDL 20140104
PACKAGE_TARNAME = AlephOne
PACKAGE_URL = 
PACKAGE_VERSION = 20140104
PATH_SEPARATOR = :
...
WINDRES = 
ZZIP_CFLAGS = -D_FORTIFY_SOURCE=2  
ZZIP_LIBS = -Wl,-Bsymbolic-functions -Wl,-z,relro -lzzip -lz  
abs_builddir = /home/radverbial/marathon-code
abs_srcdir = /home/radverbial/marathon-code
abs_top_builddir = /home/radverbial/marathon-code
abs_top_srcdir = /home/radverbial/marathon-code
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/radverbial/marathon-code/install-sh
